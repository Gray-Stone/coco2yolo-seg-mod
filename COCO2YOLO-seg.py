...
def convert_coco_to_yolo_segmentation(json_file, folder_name="labels"):
    ...
    print(f"Conversion completed. YOLO segmentation annotations saved in {folder_name} folder.")
...
if __name__ == "__main__":
    ...
    convert_coco_to_yolo_segmentation(str(json_file.resolve()), str(out_dir.resolve()))
